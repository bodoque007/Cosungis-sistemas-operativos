...
class ListaAtomica {
 ...
 public:
    ...
    void insertar(const T &valor) {
        ...
        // La semantica de esto es: setea el siguiente de nuevo_nodo en old_head 
        // Mientras _cabeza != old_head, haces old_head = _cabeza. (Esto es por si alguien insertó un elemento en el medio de la operacion y movio _cabeza)
        // Una vez que _cabeza == old_head, haces _cabeza = nuevo_nodo y ya esta.
        do {
            nuevo_nodo->_siguiente = old_head;
        } while(!_cabeza.compare_exchange_weak(old_head, nuevo_nodo));
    }
